function rxm_NumRecStokeslet_MobilityXNodes_Data
...
% For denser data used for flow-PCA-decomposition, the interpolations here
% should be:
%t_pca = linspace(0,tRange,1000*round(ncycle));
%NT_pca = linspace(1,nt,1000*round(ncycle));
...
save(['XNodes_sp',num2str(sp),'_NoBoundStokeslet.mat'],'xs','Xs','f','nhh','Nhh','ns','Ns',...
