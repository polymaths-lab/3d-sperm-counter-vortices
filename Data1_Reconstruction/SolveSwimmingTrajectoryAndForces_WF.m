function [t,z]=SolveSwimmingTrajectoryAndForces_WF(x00,b10,b20,tRange,tspan,Xh,xh,vh,Xt,xt,boundary,epsilon,domain,blockSize,varargin)
...
DOF=length(xh)+size(xt,1)+length(xib);
z0=[x00;b10;b20;zeros(DOF,1)];
[t,z]=ode113(@(t,z) SolveSwimmingProblemWithBoundary_WF(z,Xh,xh,vh,Xt,xt,boundary,t,tspan,epsilon,domain,blockSize,varargin),tRange,z0);
