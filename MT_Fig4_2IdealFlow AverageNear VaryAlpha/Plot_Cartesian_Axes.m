function Plot_Cartesian_Axes(fig,O,C)
    ...
    % Vector: line segment.
    eff_x=0.3; eff_y=0.3; eff_z=0.3; %eff_x=0.15; eff_y=0.15; eff_z=0.15; 
    ...
    cone_scal = 0.06;  %cone_scal = 0.03;
    [cone_X_x, cone_X_y, cone_X_z]=meshgrid(-3:3:3, -3:3:3, -1:1:1); 
    ...
    hcone_X = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_X_u, cone_X_v, cone_X_w,cone_X_sxyz(1),cone_X_sxyz(2),cone_X_sxyz(3),cone_scal);
    ...
    hcone_Y = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Y_u, cone_Y_v, cone_Y_w,cone_Y_sxyz(1),cone_Y_sxyz(2),cone_Y_sxyz(3),cone_scal);
    ...
    hcone_Z = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Z_u, cone_Z_v, cone_Z_w,cone_Z_sxyz(1),cone_Z_sxyz(2),cone_Z_sxyz(3),cone_scal);
