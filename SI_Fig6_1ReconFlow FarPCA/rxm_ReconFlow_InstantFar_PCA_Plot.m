function rxm_ReconFlow_InstantFar_PCA_Plot
...
if 1
    ...
    %=====================================================================================================
    % Get flow field.
    load FarFlow_CF_sp8_NoBound_Tfine.mat;
    ...
    %////////////////////////////////////////////////////////////////////////////////////////////////////////////
    view([155 15]); XL=[xl_field(1) xl_field(2)]; YL=[yl_field(1) yl_field(2)]; ZL=[zl_field(1) zl_field(2)];   %for far flow.
 ...
 if 1
    ...
    colorbar; 
    %////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    %caxis([0 0.03]);  % for raw and PCA-recon. flows. 
    caxis([0 1]);  % for far-flow PCA modes. 
 if 1   
...
if 0
    ...
    xticks([1:5]);  yticks(0.2:0.2:1) %xticks(5:5:25); 
...
if 0
% Note: because the data for the far-field flow is too big for the computer
% to calculate, only one comoving-revolution time is analyzed via PCA.
load FarFlow_CF_sp8_NoBound_Tfine.mat;
...
if 0 % mode1 versus mode2.
    ...
    Time_coef_plot=Time_coef; % the far-field PCA flow data merely includes one comoving revolution period.
    ...
    for i_bc = 1:n_bc_per_rev+1  % over one revolution period.
        scatter(Time_coef_plot(1+(i_bc-1)*np_bc,mode1),Time_coef_plot(1+(i_bc-1)*np_bc,mode2),200*i_bc,[0.9 0 0],'filled')
    end            
    xlim([-0.09 0.07]);  ylim([-0.06 0.055]);  
    xticks(-0.1:0.05:0.1);  yticks(-0.05:0.05:0.05); 
    ...
    figure(4)
    clf; set(gcf,'color','w');
    hold on;  box on; daspect([3 0.0006 1]) 
    xlim([1 1*np_rev]);  ylim([-0.09 0.07]);   
...
if 1
c = colorbar('Ticks',[0,1],'TickLabels',{'0','0.03'},'FontSize',48,'fontname','Times');  %,'FontSize',60  %,'TickLabels',{'0','1'}
...
c = colorbar('Ticks',[0,1],'TickLabels',{'0','0.3'},'FontSize',60,'fontname','Times');  %,'TickLabels',{'0','1'}
c.Label.String = 'Time (s)';
c.TickLabelInterpreter='latex';
c.Position = [0.85 0.2 0.01 0.6];  % orientation: vertical
end
