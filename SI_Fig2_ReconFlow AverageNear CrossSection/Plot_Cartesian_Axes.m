function Plot_Cartesian_Axes(fig,O,C)
    ...
    %eff_x=0.1; eff_y=2.05; eff_z=2.05; %for 2D streamslice.
    ...
    %sz = 0.1; % for 2D streamslice.
    [cone_X_x, cone_X_y, cone_X_z]=meshgrid(-3:3:3, -3:3:3, -3:3:3); %meshgrid(-3:3:3, -3:3:3, -1:1:1);  %this may need modification for different scales of figures.
