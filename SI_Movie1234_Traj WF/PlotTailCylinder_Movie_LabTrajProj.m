function PlotTailCylinder_Movie_LabTrajProj(xt,yt,zt,FAlpha,fig, XL,YL,ZL)
...
r = 2.^r_temp;%4.^r_temp;
nr=51;
[X,Y,Z] = cylinder(r*0.3,nr-1); %size(X)=nz*nr.
...
%% Plot the 2D projected (XY plane) flagellar shape in the form of a cylinder surface.
...
% 5. Set Z limit for projected flagellum.
h = Cylinder;
h.ZData = h.ZData.*0+ZL;
...
%% Plot the 2D projected (XZ plane) flagellar shape in the form of a cylinder surface.
...
% 5. Set Y limit for projected flagellum.
h = Cylinder;
h.YData = h.YData.*0+YL;
...
%% Plot the 2D projected (YZ plane) flagellar shape in the form of a cylinder surface.
...
% 5. Set X limit for projected flagellum.
h = Cylinder;
h.XData = h.XData.*0+XL;
