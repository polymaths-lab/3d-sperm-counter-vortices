function Plot_Cartesian_Axes(fig,O,C)
    ...
    sz = 0.03; 
    [cone_X_x, cone_X_y, cone_X_z]=meshgrid(-150:150:150, -150:150:150, -40:40:40); %meshgrid(-3:3:3, -3:3:3, -1:1:1);  %this may need modification for different scales of figures.
