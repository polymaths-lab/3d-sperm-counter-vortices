function [xup1_nt0_align,xup2_nt0_align,xup3_nt0_align, xdown1_nt0_align,xdown2_nt0_align,xdown3_nt0_align, Ind_xup_neck] = Get_CF_Aligned_Head(B)
...
% upside head
xup_nt0_align=ApplyRotationMatrix(B,xup); % This is for the lab frame.    
%xup_nt0_align=TranslatePoints(xup_nt0_align,neck_nt0);
...
% downside head
xdown_nt0_align=ApplyRotationMatrix(B,xdown);  % This is for the lab frame.
%xdown_nt0_align=TranslatePoints(xdown_nt0_align,neck_nt0);
