...
if 1
    ...
    %////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    slice(Xg,Yg,Zg,vel,[0.5],[],[]);
    ss=streamslice(Xg,Yg,Zg,6*Ug_mean,6*Vg_mean,6*Wg_mean,[0.5],[],[],0.3); %0.3
...
c = colorbar('Ticks',[0,clim],'FontSize',40,'TickLabels',{'0','$10^{-5}$'},'fontname','Times');  %'FontSize',65/ 80
c.Label.String = 'Flow velocity';
c.TickLabelInterpreter='latex';
c.Position = [0.7 0.1 0.008 0.8];  % orientation: vertical
return
