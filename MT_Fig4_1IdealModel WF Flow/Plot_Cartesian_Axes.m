function Plot_Cartesian_Axes(fig,O,C)
    ...
    hcone_X = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_X_u, cone_X_v, cone_X_w,cone_X_sxyz(1),cone_X_sxyz(2),cone_X_sxyz(3),0.03);
    ...
    hcone_Y = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Y_u, cone_Y_v, cone_Y_w,cone_Y_sxyz(1),cone_Y_sxyz(2),cone_Y_sxyz(3),0.03);
    ...
    hcone_Z = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Z_u, cone_Z_v, cone_Z_w,cone_Z_sxyz(1),cone_Z_sxyz(2),cone_Z_sxyz(3),0.03);
