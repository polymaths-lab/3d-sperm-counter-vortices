function Plot_Cartesian_Axes_V2(fig,O,C)
    ...
    % Vector: line segment.
    eff_x=1; eff_y=1; eff_z=1; %eff_x=0.3; eff_y=0.3; eff_z=0.3; 
    ...
    sz = 0.15; %sz = 0.05; 
    [cone_X_x, cone_X_y, cone_X_z]=meshgrid(-3:3:3, -3:3:3, -1:1:1);  %meshgrid(-30:30:30, -30:30:30, -30:30:30);   %this may need modification for different scales of figures.
