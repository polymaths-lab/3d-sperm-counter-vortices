...
[xg,yg,zg]=CalcxyFromPlanarInterp(sg,tg,model.F);

xt1=xg(:,2);xt2=yg(:,2);xt3=zg(:,2); %ÐÞ¸Ä
%xt1=45*xt1;xt2=45*xt2;xt3=45*xt3;

vt1=(xg(:,3)-xg(:,1))/dt;
vt2=(yg(:,3)-yg(:,1))/dt;
vt3=(zg(:,3)-zg(:,1))/dt; %ÐÞ¸Ä
...
[Sg,tg]=ndgrid(S,tt(:,2));
[Xt1,Xt2,Xt3]=CalcxyFromPlanarInterp(Sg,tg,model.F);
%Xt1=45*Xt1;Xt2=45*Xt2;Xt3=45*Xt3;
