function Plot_Cartesian_Axes_1(fig,O,C)
    ...
    %con_scale = 0.2; 
    %for 2d XYZ.
    eff_x=eff_x*0.82; eff_y=eff_y*0.82; eff_z=eff_z*0.82; 
    con_scale = 0.12; 
    ...
    hcone_X = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_X_u, cone_X_v, cone_X_w,cone_X_sxyz(1),cone_X_sxyz(2),cone_X_sxyz(3),con_scale);
    ...
    hcone_Y = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Y_u, cone_Y_v, cone_Y_w,cone_Y_sxyz(1),cone_Y_sxyz(2),cone_Y_sxyz(3),con_scale);
    ...
    hcone_Z = coneplot(cone_X_x, cone_X_y, cone_X_z, cone_Z_u, cone_Z_v, cone_Z_w,cone_Z_sxyz(1),cone_Z_sxyz(2),cone_Z_sxyz(3),con_scale);
